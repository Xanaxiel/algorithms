...
final class LeetCode {
     ...
     * <p>
     * The brute force is to list all profits that prices[j] - prices[i] for
     * j > i for i = 0...n-2. Then return the max of this list. Runtime O(n^2).
     * <p>
     * A better approach is to keep track of the minimum price and maximum
     * profit and update it as we loop through the array.
     *
     * @param prices array of integers representing the stock price at day i
